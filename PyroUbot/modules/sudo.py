...
<blockquote><b>『 sᴜᴅᴏ 』</b>
  ...
  ➢ ᴘᴇʀɪɴᴛᴀʜ: `{0}addsudo` [reply/username/id]
     penjelasan: untuk akses user lain agar bisa menjalankan fitur userbot mu

  ➢ ᴘᴇʀɪɴᴛᴀʜ: `{0}delsudo` [reply/username/id]
     penjelasan: untuk delte akses username

  ➢ ᴘᴇʀɪɴᴛᴀʜ: `{0}sudolist`[reply/username/id]
     penjelasan: untuk melihat list yang sudah di addsudo.</blockquote></b>
"""
