...
async def stalktt(client, message):
    ...
    url = f"https://api.botcahx.eu.org/api/stalk/tt?username={username}&apikey=0xr4lx"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if "result" in data:
                ...
                likes = result.get('likes', 'No data available')
                ...
                profile_picture_url = result.get('profile', None)
...
"""
                ...
                if profile_picture_url:
                    ...
                    photo_path = "/tmp/tiktok_profile_picture.jpg"
