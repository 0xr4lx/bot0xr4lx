...
<b>✨ ʙᴏᴛ ɪɴɪ ᴅɪᴋᴇᴍʙᴀɴɢᴋᴀɴ ᴏʟᴇʜ: @anonyrel, ᴊɪᴋᴀ ᴀᴅᴀ ᴋᴇsᴀʟᴀʜᴀɴ ᴀᴛᴀᴜᴘᴜɴ ʙᴀɴᴛᴜᴀɴ ʙɪsᴀ Dᴍ ᴏᴡɴᴇʀ ᴅɪ ᴀᴛᴀs</b>
<b>👉 Usᴇʀʙᴏᴛ ᴛɪᴅᴀᴋ ᴍᴇᴍɪʟɪᴋɪ ɢᴀʀᴀɴsɪ ᴊɪᴋᴀ ᴀᴋᴜɴ ᴋᴇ ᴅᴇᴀᴋ/ʟᴏɢ ᴏᴜᴛ, ɪᴛᴜ sᴜᴅᴀʜ ʀᴇsɪᴋᴏ ᴘᴇᴍᴀsᴀɴɢᴀɴ ᴜsᴇʀʙᴏᴛ❗</b>
<b>⛔ <a href="https://telegra.ph/RESIKO-USERBOT-04-22">BACA DISINI</a> ᴜɴᴛᴜᴋ ᴋᴇᴛᴇɴᴛᴜᴀɴ ᴘᴇɴɢɢᴜɴᴀᴀɴ Usᴇʀʙᴏᴛ.</b>

ᴋʟɪᴋ ᴛᴏᴍʙᴏʟ ᴅɪʙᴀᴡᴀʜ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴜᴀᴛ ᴜsᴇʀʙᴏᴛ</blockquote>"""
